...
namespace LoF.UI.Inventory
{
    public class ItemExplanation : MonoBehaviour
    {
        ...
        [Space(10)] [SerializeField] private TextMeshProUGUI cardName;

        [SerializeField] private Image frame;
        [SerializeField] private TextMeshProUGUI stats;
        [SerializeField] private TextMeshProUGUI invokeEffect;

        [Space(10)] [SerializeField] private CommandButton invokeButton;
        ...
        private readonly Subject<InventoryCommandType> onCommand = new();
        ...
        private void SetItem(InventorySlotView slot)
        {
            ...
            var canInvoke = slot.Type == SlotType.Inventory && view.CanInvoke;
